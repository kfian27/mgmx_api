exports.queryPosisiBank = async (tanggal) => {
    var sql = `
...
Select k.TglTrans, k.IdMCabang, k.IdMRek, k.JmlRek FROM MGKBLKartuBank k
 UNION ALL
 SELECT '2024-03-31 00:00:00' as TglTrans, IdMCabang, IdMRek, 0 as JmlRek FROM MGKBMRek
 ) TransAll
...
exports.queryKartuBank = async (start, end, bank) => { 
  let qbank = "";
    if (bank != "") {
