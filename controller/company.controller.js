...
exports.findAll = async (req, res) => {
  ...
  await Company.findAndCountAll({
    ...
    .then((company) => {
      ...
      let copyData = company.rows;
      company.rows.forEach((val, index) => {
        copyData[index].dataValues.canEdit = true;
        copyData[index].dataValues.canDelete = true;
      });
      company.rows = copyData;
      res.json({
